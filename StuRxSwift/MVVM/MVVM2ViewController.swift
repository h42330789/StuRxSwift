...
class MVVM2ViewController: BaseViewController {
    ...
    override func viewDidLoad() {
        ...
        let viewModel = GitHubViewModel2(searchAction: searchAction)
        viewModel.navigationTitle.drive(self.navigationItem.rx.title)
            .disposed(by: disposeBag)
        
        viewModel.responstires.drive(tableView.rx.items) { _, _, element in
